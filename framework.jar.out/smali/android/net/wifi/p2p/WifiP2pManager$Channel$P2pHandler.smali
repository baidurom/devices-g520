...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v8, "call onPeersAvailable()"
    ...
    const-string v8, "PeerListListener == NULL"
    ...
    check-cast v5, Landroid/net/wifi/p2p/wfd/WfdLinkInfo;

    .line 876
    .local v5, s:Landroid/net/wifi/p2p/wfd/WfdLinkInfo;
    if-eqz v2, :cond_0

    .line 877
    check-cast v2, Landroid/net/wifi/p2p/WifiP2pManager$WfdLinkInfoListener;

    .end local v2           #listener:Ljava/lang/Object;
    invoke-interface {v2, v5}, Landroid/net/wifi/p2p/WifiP2pManager$WfdLinkInfoListener;->onLinkInfoAvailable(Landroid/net/wifi/p2p/wfd/WfdLinkInfo;)V

    goto :goto_0

    .line 881
    .end local v5           #s:Landroid/net/wifi/p2p/wfd/WfdLinkInfo;
    .restart local v2       #listener:Ljava/lang/Object;
    :sswitch_5
