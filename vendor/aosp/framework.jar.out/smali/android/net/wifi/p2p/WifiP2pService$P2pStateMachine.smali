...
# instance fields
.field private mBufferWfdInfo:Landroid/net/wifi/p2p/wfd/WfdInfo;
...
.field private mPersistNetworks:Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;
...
.field private mWfdAutoConnectInfos:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;
...
.method constructor <init>(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;Z)V
    ...
    .line 648
    new-instance v0, Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;

    invoke-direct {v0}, Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;-><init>()V

    iput-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mPersistNetworks:Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;

    .line 649
    new-instance v0, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;

    invoke-direct {v0}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;-><init>()V

    iput-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWfdAutoConnectInfos:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;
...
.method static synthetic access$10400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$10500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$11300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$FrequencyConflictState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$11800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$12500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$12600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    ...
    .prologue
    .line 620
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->setWifiP2pInfoMyAddressOnGroupFormation(Ljava/lang/String;)V
...
.method static synthetic access$13200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/wfd/WfdInfo;
    .locals 1
    .parameter "x0"

    .prologue
    .line 620
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mBufferWfdInfo:Landroid/net/wifi/p2p/wfd/WfdInfo;
...
.method static synthetic access$1402(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/wfd/WfdInfo;)Landroid/net/wifi/p2p/wfd/WfdInfo;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 620
    iput-object p1, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mBufferWfdInfo:Landroid/net/wifi/p2p/wfd/WfdInfo;
...
.method static synthetic access$5600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/wfd/WfdInfo;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 620
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->setWfdInfo(Landroid/net/wifi/p2p/wfd/WfdInfo;)V
...
.method static synthetic access$5800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;
    .locals 1
    .parameter "x0"

    .prologue
    .line 620
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mPersistNetworks:Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;

    return-object v0
.end method

.method static synthetic access$5900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 620
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->syncWfdAutoConnectInfo(I)V
...
.method static synthetic access$6500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$6900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)I
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$8700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;
    .locals 1
    .parameter "x0"

    .prologue
    .line 620
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWfdAutoConnectInfos:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;

    return-object v0
.end method

.method static synthetic access$8800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;
    .locals 1
    .parameter "x0"

    .prologue
    .line 620
    invoke-direct {p0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->findWfdConnectInfoInScanResults()Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;
...
.method static synthetic access$9700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private configuredNetworkId(Ljava/lang/String;)I
    ...
    .prologue
    .line 2749
    const-string v0, "Persistent disabled"
...
.method private findWfdConnectInfoInScanResults()Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;
    .locals 6
    ...
    .line 3059
    .local v4, tryCount:I
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWfdAutoConnectInfos:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;

    iget-object v3, v5, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;->sortedInfos:Ljava/util/TreeMap;

    .line 3061
    .local v3, sortedWfdAutoConnectInfos:Ljava/util/TreeMap;,"Ljava/util/TreeMap<Ljava/lang/Integer;Ljava/lang/String;>;"
    ...
    invoke-virtual {v5, v2}, Landroid/net/wifi/p2p/WifiP2pDeviceList;->get(Ljava/lang/String;)Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    invoke-virtual {v5, v2}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;->get(Ljava/lang/String;)Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;
    ...
    .restart local v2       #peerAddress:Ljava/lang/String;
    :cond_0
...
.method private handleGroupCreationFailure()V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$9600(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$9602(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mServiceDiscReqId:Ljava/lang/String;
    invoke-static {v0, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$7902(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$9400(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$9402(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
...
.method private initializeP2pSettings()V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$1500(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mThisDevice:Landroid/net/wifi/p2p/WifiP2pDevice;
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$1500(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/wifi/p2p/WifiP2pDevice;
...
.method private initializeWfdSettings()V
    .locals 3
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mShouldEnableWfd:Z
    ...
    invoke-virtual {v0}, Landroid/net/wifi/WifiNative;->wfdReset()Ljava/lang/String;

    .line 2871
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWifiNative:Landroid/net/wifi/WifiNative;

    iget-object v1, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mBufferWfdInfo:Landroid/net/wifi/p2p/wfd/WfdInfo;

    invoke-virtual {v1}, Landroid/net/wifi/p2p/wfd/WfdInfo;->caculateWfdDevInfo()I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/net/wifi/WifiNative;->wfdSetDevInfo(I)Ljava/lang/String;
    ...
    iget v1, v1, Landroid/net/wifi/p2p/wfd/WfdInfo;->rtspPort:I

    invoke-virtual {v0, v1}, Landroid/net/wifi/WifiNative;->wfdSetCtrlPort(I)Ljava/lang/String;
    ...
    iget v1, v1, Landroid/net/wifi/p2p/wfd/WfdInfo;->maxTh:I

    invoke-virtual {v0, v1}, Landroid/net/wifi/WifiNative;->wfdSetMaxTh(I)Ljava/lang/String;
    ...
    iget v1, v1, Landroid/net/wifi/p2p/wfd/WfdInfo;->wfdFlags:I

    invoke-virtual {v0, v1}, Landroid/net/wifi/WifiNative;->wfdSetFlags(I)Ljava/lang/String;

    .line 2875
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWifiNative:Landroid/net/wifi/WifiNative;

    invoke-virtual {v0, v2}, Landroid/net/wifi/WifiNative;->wfdEnable(Z)Ljava/lang/String;

    .line 2876
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWifiNative:Landroid/net/wifi/WifiNative;

    invoke-virtual {v0}, Landroid/net/wifi/WifiNative;->wfdUpdate()Ljava/lang/String;

    .line 2877
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mWfdInfoHaveSet:Z
    invoke-static {v0, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$5502(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    const-string v1, "This WFD state after initialized wfd settings is "
    ...
    iget v1, v1, Landroid/net/wifi/p2p/WifiP2pDevice;->wfdState:I
...
.method private resumePeerWfdDevType(Landroid/net/wifi/p2p/WifiP2pDevice;)Z
    .locals 3
    .parameter "peer"
    ...
    iget-boolean v1, v1, Landroid/net/wifi/p2p/wfd/WfdInfo;->isDualRoleBeforeConnect:Z
    ...
    iput-boolean v0, v1, Landroid/net/wifi/p2p/wfd/WfdInfo;->isDualRoleBeforeConnect:Z
    ...
    const-string v1, " wfd device type to dual role"
...
.method private resumeThisWfdDevType()V
    .locals 2
    ...
    iget-boolean v0, v0, Landroid/net/wifi/p2p/wfd/WfdInfo;->isDualRoleBeforeConnect:Z
    ...
    iput-boolean v1, v0, Landroid/net/wifi/p2p/wfd/WfdInfo;->isDualRoleBeforeConnect:Z
    ...
    .line 3005
    invoke-direct {p0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->setWfdDevInfo()V

    .line 3006
    const-string v0, "Resumed this wfd device type to dual role"
...
.method private sendP2pDiscoveryChangedBroadcast(Z)V
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$14200(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->isFirstEnbale:Z
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$6000(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v2, p1}, Landroid/net/wifi/p2p/WifiP2pService;->access$14202(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    const-string v3, "discovery change broadcast "
...
.method private sendP2pPeersChangedBroadcast()V
    ...
    .prologue
    .line 2600
    const-string/jumbo v1, "sending p2p peers changed broadcast"
...
.method private sendThisDeviceChangedBroadcast()V
    ...
    .prologue
    .line 2592
    const-string/jumbo v1, "sending This Device changed broadcast"
...
.method private setWfdDevInfo()V
    .locals 2
...
.method private setWfdInfo(Landroid/net/wifi/p2p/wfd/WfdInfo;)V
    .locals 2
    .parameter "info"
    ...
    invoke-virtual {p1}, Landroid/net/wifi/p2p/wfd/WfdInfo;->caculateWfdDevInfo()I
    ...
    iget v1, p1, Landroid/net/wifi/p2p/wfd/WfdInfo;->rtspPort:I
    ...
    iget v1, p1, Landroid/net/wifi/p2p/wfd/WfdInfo;->maxTh:I
    ...
    iget v1, p1, Landroid/net/wifi/p2p/wfd/WfdInfo;->wfdFlags:I
...
.method private setWfdNotificationVisible(Z)V
    .locals 8
    .parameter "visible"
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$14600(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/app/Notification;
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$14602(Landroid/net/wifi/p2p/WifiP2pService;Landroid/app/Notification;)Landroid/app/Notification;
    ...
    invoke-virtual {v2, v3, v6}, Landroid/content/res/Resources;->getQuantityText(II)Ljava/lang/CharSequence;
    ...
    const-string v3, "WFD is disabled by Wifi P2p"
    ...
    const-string v4, "Enable WFD must enable Wifi"

    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mNotification:Landroid/app/Notification;
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService;->access$14600(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/app/Notification;

    move-result-object v5

    iget-object v5, v5, Landroid/app/Notification;->contentIntent:Landroid/app/PendingIntent;

    invoke-virtual {v2, v3, v4, v0, v5}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method private setWifiP2pInfoMyAddressOnGroupFormation(Ljava/lang/String;)V
    .locals 2
    .parameter "address"
...
.method private setWifiP2pInfoOnGroupTermination()V
    ...
    iput-object v2, v0, Landroid/net/wifi/p2p/WifiP2pInfo;->groupOwnerAddress:Ljava/net/InetAddress;

    .line 2768
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWifiP2pInfo:Landroid/net/wifi/p2p/WifiP2pInfo;

    iput-object v2, v0, Landroid/net/wifi/p2p/WifiP2pInfo;->myAddress:Ljava/net/InetAddress;
...
.method private syncWfdAutoConnectInfo(I)V
    .locals 7
    .parameter "syncMode"
    ...
    invoke-virtual {v5}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;->getInfoList()Ljava/util/Collection;
    ...
    check-cast v3, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;

    .line 3027
    .local v3, info:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mPersistNetworks:Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;

    iget-object v6, v3, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;->peerAddress:Ljava/lang/String;

    invoke-virtual {v5, v6}, Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;->getNetworkId(Ljava/lang/String;)I
    ...
    const-string/jumbo v6, "syncWfdAutoConnectInfo update netId="
    ...
    invoke-virtual {v5, v3}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;->remove(Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;)Z

    goto :goto_0

    .line 3032
    :cond_0
    iput v4, v3, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;->networkId:I

    .line 3033
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWfdAutoConnectInfos:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;

    invoke-virtual {v5, v3}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;->update(Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;)V
    ...
    const-string/jumbo v6, "syncWfdAutoConnectInfo syncMode="
    ...
    iget-object v5, v5, Landroid/net/wifi/p2p/WifiP2pConfig;->persist:Landroid/net/wifi/p2p/WifiP2pConfig$Persist;

    sget-object v6, Landroid/net/wifi/p2p/WifiP2pConfig$Persist;->YES:Landroid/net/wifi/p2p/WifiP2pConfig$Persist;
    ...
    invoke-virtual {v5, v0}, Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;->getNetworkId(Ljava/lang/String;)I
    ...
    const-string/jumbo v6, "syncWfdAutoConnectInfo add networkId:"
    ...
    const-string v6, " mPersistNetworks: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mPersistNetworks:Landroid/net/wifi/p2p/pesistent/WifiP2pPersistNetworkList;
    ...
    .line 3043
    new-instance v1, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;

    invoke-direct {v1}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;-><init>()V

    .line 3044
    .local v1, connectInfo:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;
    const/4 v5, -0x1

    if-le v4, v5, :cond_2

    .line 3045
    iput v4, v1, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;->networkId:I

    .line 3046
    iput-object v0, v1, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;->peerAddress:Ljava/lang/String;

    .line 3047
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mThisDevice:Landroid/net/wifi/p2p/WifiP2pDevice;
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService;->access$1500(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/wifi/p2p/WifiP2pDevice;

    move-result-object v5

    iget-object v5, v5, Landroid/net/wifi/p2p/WifiP2pDevice;->wfd:Landroid/net/wifi/p2p/wfd/WfdInfo;

    iput-object v5, v1, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;->wfd:Landroid/net/wifi/p2p/wfd/WfdInfo;

    .line 3048
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWfdAutoConnectInfos:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;

    invoke-virtual {v5, v1}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;->update(Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;)V

    .line 3052
    .end local v0           #address:Ljava/lang/String;
    .end local v1           #connectInfo:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfo;
    :cond_2
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWfdAutoConnectInfos:Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;

    invoke-virtual {v5}, Landroid/net/wifi/p2p/wfd/WfdAutoConnectInfoList;->updateWfdAutoConnectInfoFile()V
...
.method public getPeerIpAddress(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v13, "getPeerIpAddress deviceAddress="
    ...
    invoke-direct {p0, v12}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->logd(Ljava/lang/String;)V
    ...
    const-string v13, "getPeerIpAddress mThisDevice.isGroupOwner()="
    ...
    .line 2515
    iget-object v12, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mGroup:Landroid/net/wifi/p2p/WifiP2pGroup;
    ...
    invoke-static {v12}, Landroid/net/wifi/p2p/WifiP2pService;->access$11100(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/String;
    ...
    const-string v12, "getPeerIpAddress goIpAddress="
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->goIpAddress:Ljava/lang/String;
    invoke-static {v12}, Landroid/net/wifi/p2p/WifiP2pService;->access$12800(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/String;
    ...
    invoke-direct {p0, v11}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->logd(Ljava/lang/String;)V

    .line 2518
    iget-object v11, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->goIpAddress:Ljava/lang/String;
    invoke-static {v11}, Landroid/net/wifi/p2p/WifiP2pService;->access$12800(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/String;
    ...
    .line 2520
    :cond_2
    const-string v12, "getPeerIpAddress goIpAddress=null"
    ...
    const-string v12, "/data/misc/dhcp/dnsmasq.p2p0.leases"
    ...
    const-string v12, "getClientIp before read file line"
    ...
    const-string v13, "getClientIp Read Message = "
    ...
    const-string v13, "getClientIp read a line ok str = "
    ...
    const-string v13, "getClientIp fields = "
    ...
    const-string v13, "getClientIp get IP address = "
    ...
    .line 2555
    const-string v12, "getClientIp close file OK!"
    ...
    .line 2547
    invoke-direct {p0, v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->logd(Ljava/lang/String;)V
    :try_end_3
