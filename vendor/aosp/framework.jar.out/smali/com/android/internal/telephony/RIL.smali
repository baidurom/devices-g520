...
.method public constructor <init>(Landroid/content/Context;III)V
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/RIL;->mHangUpTimerList:Ljava/util/ArrayList;
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/RIL;->mRequestsList:Ljava/util/ArrayList;
    ...
    .line 334
    iput-boolean v10, p0, Lcom/android/internal/telephony/RIL;->isScreenOn:Z

    .line 348
    iput v9, p0, Lcom/android/internal/telephony/RIL;->radioTemporarilyUnavailable:I

    .line 354
    iput v9, p0, Lcom/android/internal/telephony/RIL;->dtmfRequestCount:I

    .line 355
    const/16 v7, 0x20

    iput v7, p0, Lcom/android/internal/telephony/RIL;->MAXIMUM_DTMF_REQUEST:I

    .line 357
    iput v9, p0, Lcom/android/internal/telephony/RIL;->getAvailableNetworkRequests:I

    .line 362
    iput-boolean v10, p0, Lcom/android/internal/telephony/RIL;->mIsFirstResponse:Z
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/RIL;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/RIL;->mDataListChangedHandler:Landroid/os/Handler;

    .line 6515
    new-instance v7, Lcom/android/internal/telephony/RIL$3;

    invoke-direct {v7, p0}, Lcom/android/internal/telephony/RIL$3;-><init>(Lcom/android/internal/telephony/RIL;)V

    iput-object v7, p0, Lcom/android/internal/telephony/RIL;->mCatServiceInitListener:Landroid/content/BroadcastReceiver;
    ...
    const-string v8, "SOCKET_NAME_RIL_1 = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Lcom/android/internal/telephony/RIL;->SOCKET_NAME_RIL_1:Ljava/lang/String;
    ...
    const-string v8, "SOCKET_NAME_RIL_2 = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Lcom/android/internal/telephony/RIL;->SOCKET_NAME_RIL_2:Ljava/lang/String;
    ...
    .line 798
    iput v9, p0, Lcom/android/internal/telephony/RIL;->mRequestMessagesPending:I

    .line 799
    iput v9, p0, Lcom/android/internal/telephony/RIL;->mRequestMessagesWaiting:I
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/RIL;->mServiceStateExt:Lcom/mediatek/common/telephony/IServiceStateExt;
    :try_end_0
    ...
    const-string v7, "android.intent.action.ACTION_CAT_INIT_DONE"

    invoke-virtual {v3, v7}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 843
    iget-object v7, p0, Lcom/android/internal/telephony/RIL;->mCatServiceInitListener:Landroid/content/BroadcastReceiver;
    ...
    const-string v8, "[CachedStk register receiver to listen CAT init"
    ...
    sput-object v7, Lcom/android/internal/telephony/RIL;->SOCKET_NAME_RIL_1:Ljava/lang/String;

    .line 761
    const-string/jumbo v7, "rild2"

    sput-object v7, Lcom/android/internal/telephony/RIL;->SOCKET_NAME_RIL_2:Ljava/lang/String;

    goto/16 :goto_0

    .line 765
    :pswitch_1
    const-string/jumbo v7, "rild-md2"

    sput-object v7, Lcom/android/internal/telephony/RIL;->SOCKET_NAME_RIL_1:Ljava/lang/String;

    .line 766
    const-string/jumbo v7, "rild2-md2"
    ...
    :cond_3
    const-string v7, "Starting RILReceiver"
    ...
    invoke-direct {v7, p0, p4}, Lcom/android/internal/telephony/RIL$RILReceiver;-><init>(Lcom/android/internal/telephony/RIL;I)V
    ...
    .line 832
    iget-object v7, p0, Lcom/android/internal/telephony/RIL;->mIntentReceiver:Landroid/content/BroadcastReceiver;
...
.method private processUnsolicited(Landroid/os/Parcel;)V
    ...
    const-string v36, "Unrecognized unsol response: "
    ...
    const-string v34, "RILJ"

    new-instance v35, Ljava/lang/StringBuilder;

    invoke-direct/range {v35 .. v35}, Ljava/lang/StringBuilder;-><init>()V

    const-string v36, "Exception processing unsol response: "
    ...
    .line 3133
    .local v19, newState:Lcom/android/internal/telephony/CommandsInterface$RadioState;
    ...
    .line 3051
    .end local v19           #newState:Lcom/android/internal/telephony/CommandsInterface$RadioState;
    :sswitch_2
    :try_start_2
    invoke-direct/range {p0 .. p1}, Lcom/android/internal/telephony/RIL;->responseVoid(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    .local v28, ret:Ljava/util/ArrayList;
    goto/16 :goto_1

    .line 3077
    .end local v28           #ret:Ljava/util/ArrayList;
    :sswitch_1c
    ...
    invoke-virtual/range {v34 .. v35}, Landroid/os/Registrant;->notifyRegistrant(Landroid/os/AsyncResult;)V
    ...
    const-string v35, " NEW_SMS_ON_SIM ERROR with wrong length "
    ...
    .line 3219
    const-string v34, "ignoring UNSOL_NITZ_TIME_RECEIVED"
    ...
    const-string v35, "[CachedStk unregister mCatServiceInitListener"
    ...
    invoke-virtual/range {v34 .. v35}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    :try_end_3
    ...
    const-string v35, "[CachedStk mCatServiceInitListener has been unregistered"
    ...
    const-string v35, "[CachedStk uncaught exception"
    ...
    const-string v35, "[CachedStk cache proactive command"
    ...
    invoke-virtual/range {v34 .. v34}, Landroid/os/Registrant;->notifyRegistrant()V
    ...
    check-cast v24, Lcom/android/internal/telephony/cdma/CdmaInformationRecords;

    .line 3420
    .local v24, rec:Lcom/android/internal/telephony/cdma/CdmaInformationRecords;
    move-object/from16 v0, p0
    ...
    .end local v24           #rec:Lcom/android/internal/telephony/cdma/CdmaInformationRecords;
    :catch_3
    move-exception v8
    ...
    const-string v35, "Unexpected exception casting to listInfoRecs"
    ...
    .line 3548
    const-string v34, "[dwj] RIL_UNSOL_CALL_PROGRESS_INFO and is disconnected now"
    ...
    check-cast v33, Lcom/android/internal/telephony/RIL$TimerWithIndex;

    .line 3553
    .local v33, tt:Lcom/android/internal/telephony/RIL$TimerWithIndex;
    invoke-virtual/range {v33 .. v33}, Lcom/android/internal/telephony/RIL$TimerWithIndex;->getCallIndex()I
    ...
    const-string v36, "[dwj] Call Disconnected generated by ourselves "
    ...
    .line 3557
    invoke-virtual/range {v33 .. v33}, Lcom/android/internal/telephony/RIL$TimerWithIndex;->cancel()V
    ...
    .line 3568
    .end local v13           #i:I
    .end local v33           #tt:Lcom/android/internal/telephony/RIL$TimerWithIndex;
    :cond_8
    :goto_5
    move-object/from16 v0, p0
    ...
    .restart local v33       #tt:Lcom/android/internal/telephony/RIL$TimerWithIndex;
    :cond_9
    ...
    :cond_a
    :try_start_6
    const-string v34, "[dwj] It seems the other side release the call or we already have remove it from the list"
    ...
    sput v34, Lcom/android/internal/telephony/RIL;->mSimInsertedStatus:I
    ...
    .line 3669
    .local v29, scriResult:Ljava/lang/Integer;
    new-instance v34, Ljava/lang/StringBuilder;
    ...
    .line 3680
    .end local v29           #scriResult:Ljava/lang/Integer;
    :sswitch_75
    move-object/from16 v0, p0
    ...
    const-string v34, "com.VendorName.CauseCode"
    ...
    const-string v35, "Broadcast for ACMT: com.VendorName.CauseCode "
    ...
    .line 3763
    const-string v34, "Broadcast for EMMRRS: android.intent.action.EMMRRS_PS_RESUME "
...
.method private responseOperatorInfos(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    const-string v15, "RIL_REQUEST_QUERY_AVAILABLE_NETWORKS: invalid response. Got "
    ...
    const-string v15, " strings, expected multible of 5"
    ...
    .line 4196
    .local v6, lacStr:Ljava/lang/String;
    const/4 v7, 0x0
    ...
    const-string v15, " lacStr.length="
    ...
    const-string v15, " strings.length="
    ...
    const-string/jumbo v14, "lacValid set to true"
    ...
    .line 4215
    const-string/jumbo v13, "responseOperatorInfos handling UCS2 format name"
    ...
    invoke-static {v15}, Lcom/android/internal/telephony/RIL;->hexStringToBytes(Ljava/lang/String;)[B
    ...
    iget-object v13, v0, Lcom/android/internal/telephony/RIL;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-virtual {v13}, Lcom/android/internal/telephony/IccCard;->getIccRecords()Lcom/android/internal/telephony/IccRecords;

    move-result-object v13

    check-cast v13, Lcom/android/internal/telephony/gsm/SIMRecords;
    ...
    .line 4229
    .local v10, sEons:Ljava/lang/String;
    ...
    const-string/jumbo v15, "lacIndex="
    ...
    invoke-virtual {v11, v13, v8, v14}, Lcom/android/internal/telephony/gsm/SIMRecords;->getEonsIfExist(Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    const-string/jumbo v15, "plmn name update to Eons: "
    ...
    .line 4248
    .end local v4           #lac:Ljava/lang/String;
    .end local v8           #lacValue:I
    .end local v10           #sEons:Ljava/lang/String;
    .end local v11           #simRecords:Lcom/android/internal/telephony/gsm/SIMRecords;
    :cond_3
    :goto_2
    add-int/lit8 v13, v3, 0x0
    ...
    .line 4249
    :cond_4
    const-string/jumbo v13, "lookup RIL responseOperatorInfos()"
    ...
    invoke-virtual {v0, v14, v15}, Lcom/android/internal/telephony/RIL;->lookupOperatorName(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v15, "basebandCapability = "
    ...
    .line 4261
    :cond_6
    new-instance v13, Lcom/android/internal/telephony/OperatorInfo;
    ...
    invoke-direct/range {v13 .. v17}, Lcom/android/internal/telephony/OperatorInfo;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 4219
    .end local v1           #basebandCapability:I
    :catch_0
    move-exception v2

    .line 4220
    .local v2, ex:Ljava/io/UnsupportedEncodingException;
    const-string/jumbo v13, "responseOperatorInfos UnsupportedEncodingException"
    ...
    .restart local v4       #lac:Ljava/lang/String;
    .restart local v8       #lacValue:I
    .restart local v10       #sEons:Ljava/lang/String;
    .restart local v11       #simRecords:Lcom/android/internal/telephony/gsm/SIMRecords;
    :cond_7
    const-string v13, "RILJ"

    const-string v14, "invalid lac ignored"
