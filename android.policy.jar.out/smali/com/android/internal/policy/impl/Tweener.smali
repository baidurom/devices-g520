.class Lcom/android/internal/policy/impl/Tweener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/policy/impl/Tweener;->sTweens:Ljava/util/HashMap;

    .line 141
    new-instance v0, Lcom/android/internal/policy/impl/Tweener$1;

    invoke-direct {v0}, Lcom/android/internal/policy/impl/Tweener$1;-><init>()V

    sput-object v0, Lcom/android/internal/policy/impl/Tweener;->mCleanupListener:Landroid/animation/Animator$AnimatorListener;
...
.method public constructor <init>(Landroid/animation/ObjectAnimator;)V
    ...
    .line 41
    iput-object p1, p0, Lcom/android/internal/policy/impl/Tweener;->animator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$000(Landroid/animation/Animator;)V
    ...
    .prologue
    .line 33
    invoke-static {p0}, Lcom/android/internal/policy/impl/Tweener;->remove(Landroid/animation/Animator;)V
...
.method private static remove(Landroid/animation/Animator;)V
    ...
    .prologue
    .line 45
    sget-object v2, Lcom/android/internal/policy/impl/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 46
    .local v1, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/android/internal/policy/impl/Tweener;>;>;"
    :cond_0
    ...
    .line 48
    .local v0, entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/android/internal/policy/impl/Tweener;>;"
    invoke-interface {v0}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/internal/policy/impl/Tweener;

    iget-object v2, v2, Lcom/android/internal/policy/impl/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .line 55
    .end local v0           #entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/android/internal/policy/impl/Tweener;>;"
    :cond_1
    return-void
.end method
...
.method private static varargs replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
    ...
    sget-object v5, Lcom/android/internal/policy/impl/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 167
    .local v4, tween:Lcom/android/internal/policy/impl/Tweener;
    if-eqz v4, :cond_0

    .line 168
    iget-object v5, v4, Lcom/android/internal/policy/impl/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .line 170
    iget-object v6, v4, Lcom/android/internal/policy/impl/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .end local v4           #tween:Lcom/android/internal/policy/impl/Tweener;
    :cond_2
    return-void
.end method
...
.method public static reset()V
    ...
    .prologue
    .line 161
    sget-object v0, Lcom/android/internal/policy/impl/Tweener;->sTweens:Ljava/util/HashMap;
...
.method public static varargs to(Ljava/lang/Object;J[Ljava/lang/Object;)Lcom/android/internal/policy/impl/Tweener;
    .locals 18
    .parameter "object"
    .parameter "duration"
    .parameter "vars"
    ...
    .end local v13           #value:Ljava/lang/Object;
    :cond_c
    sget-object v14, Lcom/android/internal/policy/impl/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    check-cast v11, Lcom/android/internal/policy/impl/Tweener;

    .line 100
    .local v11, tween:Lcom/android/internal/policy/impl/Tweener;
    const/4 v2, 0x0
    ...
    .line 104
    new-instance v11, Lcom/android/internal/policy/impl/Tweener;

    .end local v11           #tween:Lcom/android/internal/policy/impl/Tweener;
    invoke-direct {v11, v2}, Lcom/android/internal/policy/impl/Tweener;-><init>(Landroid/animation/ObjectAnimator;)V

    .line 105
    .restart local v11       #tween:Lcom/android/internal/policy/impl/Tweener;
    sget-object v14, Lcom/android/internal/policy/impl/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 128
    :cond_f
    sget-object v14, Lcom/android/internal/policy/impl/Tweener;->mCleanupListener:Landroid/animation/Animator$AnimatorListener;
    ...
    check-cast v14, Lcom/android/internal/policy/impl/Tweener;

    iget-object v2, v14, Lcom/android/internal/policy/impl/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v10, v14}, Lcom/android/internal/policy/impl/Tweener;->replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
...
# virtual methods
.method varargs from(Ljava/lang/Object;J[Ljava/lang/Object;)Lcom/android/internal/policy/impl/Tweener;
    .locals 1
    .parameter "object"
    .parameter "duration"
    .parameter "vars"
    ...
    .prologue
    .line 137
    invoke-static {p1, p2, p3, p4}, Lcom/android/internal/policy/impl/Tweener;->to(Ljava/lang/Object;J[Ljava/lang/Object;)Lcom/android/internal/policy/impl/Tweener;
