...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/mtp/MtpDatabase$MtpDatabaseThread;
    }
.end annotation
...
.field private mThread:Landroid/mtp/MtpDatabase$MtpDatabaseThread;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iput-object v10, p0, Landroid/mtp/MtpDatabase;->mThread:Landroid/mtp/MtpDatabase$MtpDatabaseThread;
    ...
    .line 156
    new-instance v10, Landroid/mtp/MtpDatabase$MtpDatabaseThread;

    invoke-direct {v10, p0, p1}, Landroid/mtp/MtpDatabase$MtpDatabaseThread;-><init>(Landroid/mtp/MtpDatabase;Landroid/content/Context;)V

    iput-object v10, p0, Landroid/mtp/MtpDatabase;->mThread:Landroid/mtp/MtpDatabase$MtpDatabaseThread;

    .line 157
    iget-object v10, p0, Landroid/mtp/MtpDatabase;->mThread:Landroid/mtp/MtpDatabase$MtpDatabaseThread;

    invoke-virtual {v10}, Landroid/mtp/MtpDatabase$MtpDatabaseThread;->start()V
...
.method private getObjectList(III)[I
    ...
    const-string v9, "getObjectList: storageID = 0x "
    ...
    const-string v9, "getObjectList: format = 0x"
    ...
    const-string v9, "getObjectList: parent = 0x"
    ...
    .line 550
    invoke-direct {p0, p1, p3}, Landroid/mtp/MtpDatabase;->getObjectPath(II)Ljava/lang/String;
    ...
    .line 553
    iget-object v7, p0, Landroid/mtp/MtpDatabase;->mThread:Landroid/mtp/MtpDatabase$MtpDatabaseThread;

    iget-object v7, v7, Landroid/mtp/MtpDatabase$MtpDatabaseThread;->mHandler:Landroid/os/Handler;

    iget-object v8, p0, Landroid/mtp/MtpDatabase;->mThread:Landroid/mtp/MtpDatabase$MtpDatabaseThread;

    iget-object v8, v8, Landroid/mtp/MtpDatabase$MtpDatabaseThread;->mHandler:Landroid/os/Handler;

    const/4 v9, 0x1

    invoke-virtual {v8, v9, v4}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string v8, "getObjectList: c == null!!"
    ...
    const-string v9, "getObjectList: count = "
    ...
    const-string v9, "getObjectList: result["
    ...
    invoke-static {v7, v8}, Lcom/mediatek/xlog/SXlog;->v(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v8, "getObjectList: result[0] = 0x00!!"
...
.method private getObjectPath(II)Ljava/lang/String;
    .locals 12
    .parameter "storageID"
    .parameter "handle"
    ...
    const-string v2, "getObjectPath handle = "
    ...
    const-string v2, "getObjectPath storageID = "
    ...
    .line 1074
    :cond_0
    iget-object v10, p0, Landroid/mtp/MtpDatabase;->mMediaStoragePath:Ljava/lang/String;
    ...
    check-cast v11, Landroid/mtp/MtpStorage;

    .line 1076
    .local v11, storage:Landroid/mtp/MtpStorage;
    invoke-virtual {v11}, Landroid/mtp/MtpStorage;->getStorageId()I
    ...
    .line 1077
    invoke-virtual {v11}, Landroid/mtp/MtpStorage;->getPath()Ljava/lang/String;

    move-result-object v10

    .line 1103
    .end local v9           #i$:Ljava/util/Iterator;
    .end local v11           #storage:Landroid/mtp/MtpStorage;
    :cond_2
    :goto_0
    return-object v10
    ...
    const-string v2, "getObjectPath RESPONSE_OK: path = "
    ...
    const-string v2, "getObjectPath RESPONSE_INVALID_OBJECT_HANDLE, handle = "
